...
@TemplateDefinition(
        ...
        version = 1,
        description = "Send mails using Thymeleaf and TLS 1.3 and Keycloak to resolve users",
        ...
        groupIds = {},
        groupLabels = {},
        defaultErrorHandlingExpressionDescription = "",
        defaultOutputMappingResultExpressionDescription = "Expression to handle <a href=\"\">errors</a>. Details in the <a href=\"https://docs.camunda.io/docs/components/connectors/use-connectors/\" target=\"_blank\">documentation</a>."
)
@Getter
@Setter
